...
export class ActivateAccountEmailTemplate {
    ...
    constructor(first_name: string, last_name: string, jwt: string) {
            ...
            <html lang="en">
                ...
                <body>
                    ...
                    <div class="text-to-activate">
                        ...
                        <div class="thank-you">
                            Thank you for trusting us and register to our e-Commerce Control Panel
                        ...
                        <div class="activate-link">
                            ...
                            <a href="${config.activation_link_live}${jwt}">here</a>.
                        </div>
                    </div>
