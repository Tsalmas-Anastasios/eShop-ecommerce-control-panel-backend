...
import { OrderConfirmationMailUsedData } from '../../../models';



export class OrderConfirmationMail {

    html: string;

    constructor(data: OrderConfirmationMailUsedData) {
                ...
                <body>
                    ...
                    <div class="frame">
                        ...
                        <div class="text">
                            ...
                            <p>
                                we just received your order! We work on it and we will be back soon to
                                inform you about the order's details and its status!
                            </p>
                            <p class="order-number">
                                Your order number is <span class="bold">${data.order_number}</span>
                            </p>
                            <p>
