...
export class PasswordResetEmailTemplate {
    ...
    constructor(jwt: string, first_name: string, last_name: string) {
        ...
        this.html = `
            ...
            <html lang="en">
                <head>
                    ...
                    <title>Password reset link | Bizyhive</title>
                ...
                <body>
                    <div class="general-frame">
                        ...
                        <div class="text-to-activate">
                            ...
                            <div class="thank-you">
                                We have received a request to reset your password. You can reset your
                        ...
                        <a href="${config.password_change_request_link_live}${jwt}" class="reset-password-btn">
                            Reset Password
                        </a>
