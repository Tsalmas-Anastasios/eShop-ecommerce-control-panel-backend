...
import { OrderCancelledByCustomerMailData } from '../../../models';





export class OrderCancelledByCustomerMail {

    html: string;

    constructor(data: OrderCancelledByCustomerMailData) {
                ...
                <body>
                    <div class="shop-credentials">
                        <div class="logo">
                            <a href="${data.shop_url}">
                                <img src="${data.shop_logo}" alt="Shop name" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="frame">
                        ...
                        <div class="text">
                            ...
                            <p>
                                we just inform that you decided to cancel your order (${data.order_number}) on our system. We want to offer to you the best customer
                                experience. If we made anything wrong, for you, please let us know
                                about it with answer to this email or rate us on the Google.
                            </p>
                            <p>
                                We hope to prefer us the next time you want to shop and we make it
                                possible and offer to you the best shopping experience!
                            </p>
                            <p class="secured-by">
