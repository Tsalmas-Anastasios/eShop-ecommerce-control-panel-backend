...
export class ActivateAccount2FAAuthenticationEmailSystem {

    html: string;

    constructor(first_name: string, last_name: string, code_6digit: string) {
        ...
        this.html = `
            ...
            <html lang="en">
                <head>
                    ...
                    <title>2FA Activation | Bizyhive Suit</title>
                ...
                <body>
                    ...
                    <div class="title">
                        2 Factor Authentication via Email activation
                    </div>
                    ...
                    <div class="text-to-activate">
                        ...
                        <div class="activate-link">
                            Here is your authentication one-time code
