...
export class InvitedUserActivationEmailTemplate {

    html: string;

    constructor(first_name: string, last_name: string, shop_name: string, jwt: string) {
            ...
            <html lang="en">
                ...
                <body>
                    ...
                    <div class="text-to-activate">
                        <div class="personal-name">Dear
                            <span>${first_name} ${last_name}</span>,
                        </div>
                        <div class="thank-you">
                        You have been invited to participate as a user/operator of the shop
                        ${shop_name} in the e-Commerce Control Panel application
                        ...
                        <div class="activate-link">
                            ...
                            <a href="${config.invited_user_activation_link_live}${jwt}">here</a>.
                        </div>
                    </div>
