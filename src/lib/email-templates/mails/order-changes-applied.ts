...
import { OrderChangesAppliedMail } from '../../../models';



export class OrderChangesApplied {

    html: string;

    constructor(data: OrderChangesAppliedMail) {
                ...
                <body>
                    ...
                    <div class="frame">
                        ...
                        <div class="text">
                            ...
                            <p>
                                we are glad to inform you that the changes that you reuested have been
                                successfully applied and your order data was updated.
                            </p>
                            <p>
                                Our team is working on your order and we will inform you as soon as
                                possible about the process. Thank you for your preference!
                            </p>

                            <p class="order-number" style="font-style: italic;">
                                The best time of the day for us, is when we give your order to your
                                hands! This smile is incredible and unvaluable!😊
                            </p>
                                        ...
                                        <div class="address-info">
                                            <div class="billing-info">
                                                ...
                                                <div class="info-details">
                                                    <div class="info-column">
                                                        ${data.billing__address}, ${data.billing__city}, ${data.billing__postal_code}, ${data.billing__country}
                                                    </div>
                                                    <div class="info-column">${data.billing__phone_number}</div>
                                                    <div class="info-column">
                                                        ${data.billing__first_name} ${data.billing__last_name}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="delivery-details">
                                                <div class="address-title">Delivery details</div>
                                                    <div class="info-details">
                                                    <div class="info-column">
                                                        ${data.delivery__address}, ${data.delivery__city}, ${data.delivery__postal_code},${data.delivery__country}
                                                    </div>
                                                    <div class="info-column">${data.delivery__phone_number}</div>
                                                    <div class="info-column">
                                                        ${data.delivery__first_name} ${data.delivery__last_name}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
