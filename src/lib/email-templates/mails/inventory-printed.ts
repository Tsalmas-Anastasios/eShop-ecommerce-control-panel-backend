...
export class ProductsInventoryIssuedEmailTemplate {
        ...
        this.html = `
            ...
            <html lang="en">
                <head>
                    ...
                    <title>New inventory of your products issued | Bizyhive</title>
                ...
                <body>
                    <div class="general-frame">
                        <div class="title">
                            New inventory of your products issued
                        </div>

                        <div class="text-to-activate">
                            <div class="thank-you">
                                A new inventory of products in your company's warehouses has been issued.
                                From an account with inventory viewing rights, visit the corresponding page
                                of the dashboard to view the inventory.
                            </div>
